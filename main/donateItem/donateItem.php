...
<script src="donateItem.js"> </script>
...
<body>
    <div class="wrapper" id="">
        ...
        <form class="form-signin" id="myForm" method="POST" enctype="multipart/form-data" action="" onkeypress="return event.keyCode !=13">
            <h2 class="form-signin-heading">Donate Item</h2>
            <p>Barcode(条形码):</p>
            
            <input class="form-control" tupe="text" id="barcode" name="barcode" onkeyup="donateItem(this.value)" />
