...
function sendData(type,gender,color,description,price,size,returndonate,barcode)
{
    console.log("1");
////////////////
    name1 = type+" "+gender+" "+color;
	
	var name2 = description;
	var beforedata = "CT~~CD,~CC^~CT~\
...
^LL0280\
^LS0\
^FT410,218^A0I,31,36^FH\^FD"+name1+"^FS\
^BY3,3,49^FT378,58^BCI,,Y,N\
^FD>;"+barcode+"^FS\
^FT409,178^A0I,31,36^FH\^FD"+name2+"^FS\
^FT63,142^A0I,28,28^FH\^FD"+returndonate+"^FS\
^FT402,143^A0I,28,28^FH\^FD$^FS\
^FT391,143^A0I,28,28^FH\^FD"+price+"^FS\
^FT267,143^A0I,28,28^FH\^FDSize:"+size+"^FS\
^PQ1,0,1,Y^XZ\
";
////////////////
    
    selected_printer.send(beforedata, undefined, errorCallback);
